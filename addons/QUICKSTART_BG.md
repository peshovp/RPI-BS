...
**Версия:** 1.3.2 | **Дата:** Декември 2025

## ⚡ Най-Важното (TL;DR)

**НОВА критична функция в v1.3.2:**
- 🚀 **OTA Update Manager** - Web-based updates без SSH достъп!
- 🔄 **Rollback функционалност** - Връщане към предишна версия с 1 click
- ⚡ **Асинхронни операции** - Update/rollback без browser timeout
- ✅ **Auto Survey logging** - Автоматично спиране на логване след survey
- ✅ Ръчни контроли за start/stop logging в UI
- ✅ API endpoints за logging и OTA управление
