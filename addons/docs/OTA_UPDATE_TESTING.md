# Testing OTA Update Manager on BaseStation

## Quick Test on Production Station

### 1. SSH to BaseStation
```bash
ssh peshovp@basestation-ip
...
Open browser: `http://basestation-ip/geomaxima/update`
...
**Ready to test?** → SSH to BaseStation and start with step 1! 🚀
