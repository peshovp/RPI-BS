...
class PPPProcessor:
    ...
    def process_ppp(self,
        ...
        try:
            ...
            #       output captured on BaseStation during Phase 2a Check 1:
...
#    BaseStation against a real .obs file plus the sp3/clk/atx files already
...
#    BaseStation during Phase 2a Check 1 - it would have been silently
